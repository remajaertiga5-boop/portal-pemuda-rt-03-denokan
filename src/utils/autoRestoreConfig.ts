...
export function autoRestoreKonfigurasiAPI(existingConfigs: any[]): any[] {
  ...
  if (geminiKey) {
    ...
    if (!existing || !existing.ValueField1) {
      ...
      console.log('[autoRestore] ✅ Gemini AI auto-configured from env');
    }
  }
