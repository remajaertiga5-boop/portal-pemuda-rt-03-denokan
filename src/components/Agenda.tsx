        ...
        >
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-500 font-semibold"
            >
            ...
            return (
              ...
              >
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>{item.Waktu || "19:00"} WIB</span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="pt-4 mt-2 border-t border-slate-100 dark:border-slate-800 flex flex-wrap gap-2">
                  ...
                  <button
                    disabled={hasAbsen}
                    onClick={() => handleAbsenHadir(item)}
                    className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all flex justify-center items-center gap-1 shadow-sm dark:shadow-none ${
                      hasAbsen
            ...
            <div className="space-y-2">
              ...
              <div className="max-h-36 overflow-y-auto space-y-1 text-xs">
                {absensiList.filter((abs) => abs.ID_Agenda === selectedAgenda.ID).length === 0 ? (
                  ...
                  absensiList
                    .filter((abs) => abs.ID_Agenda === selectedAgenda.ID)
                    .map((a) => (
                      <div
                        key={a.id}
                        className="p-2 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-xl flex justify-between items-center"
                      >
