...
const DEFAULT_NOTIFICATIONS: Notification[] = [
  { id: 1, title: "Iuran Juli 2026",       body: "Tagihan iuran bulan Juli sebesar Rp 20.000 telah diterbitkan.",          time: "1 jam yang lalu",  read: false, type: "keuangan"  },
  { id: 2, title: "Rapat Rutin Remaja",    body: "Agenda rapat bulan Juli diadakan hari Minggu besok pukul 19.30 WIB.",    time: "5 jam yang lalu",  read: false, type: "agenda"    },
  { id: 3, title: "Kerja Bakti RT",        body: "Kerja bakti bersama warga membersihkan saluran air hari Sabtu jam 07.00.",time: "1 hari yang lalu", read: true,  type: "pengumuman" },
];
          ...
          <div>
            ...
            <div className="space-y-0.5">
              {navItems.map(item => {
                ...
                // ✅ Badge notifikasi per menu
                const badgeMap: Record<string, { text: string; color: string }> = {
                  pengumuman: { text: `${unreadCount > 0 ? unreadCount : "3"} baru`, color: "bg-rose-500 text-white" },
                  aspirasi  : { text: "2", color: "bg-amber-500 text-white" },
                };
